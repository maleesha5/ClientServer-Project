 ...
 * 
 */
@WebServiceClient(name = "Customer_service", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8080/Customer_Service/Customer_service?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICE_QNAME = new QName("http://ws/", "Customer_service");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Customer_Service/Customer_service?wsdl");
    ...
    public CustomerService getCustomerServicePort() {
        return super.getPort(new QName("http://ws/", "Customer_servicePort"), CustomerService.class);
    }
    ...
    public CustomerService getCustomerServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "Customer_servicePort"), CustomerService.class, features);
    }
